package com.example.votingsystem.SliderPackage;
...
public class The_Slide_items_Pager_Adapter extends PagerAdapter {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        ...
        Picasso.get().load(theSlideItemsModelClassList.get(position).getFeatured_image()).fit().centerCrop().error(R.drawable.ic_baseline_error_outline_24).into(featured_image);
